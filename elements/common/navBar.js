...
function createNavBar(navBarInfo, currentLanguage) {
    ...
    const profileButton = createElement('img', {
        src: belhardSiteData.controlElements.profileIcon,
        alt: 'Аккаунт',
        class: 'profile-icon',
        width: belhardSiteData.controlElementsSizes.profileIcon,
        height: belhardSiteData.controlElementsSizes.profileIcon
    }, document.body);

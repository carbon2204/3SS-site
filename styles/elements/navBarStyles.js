...
.search-wrapper {
    ...
    right: 105px;                     /* Располагает контейнер на 8 пикселей от правого края */
...
.search-input.expanded {
    ...
    transform: translateX(-5px);       /* Возвращает инпут в видимую область */
}

/* Когда счетчик активен */
.search-wrapper.search-shifted {
    right: 180px;                    /* Сдвигает контейнер поиска вправо на 80 пикселей */
}
...
.search-wrapper.search-mobile {
    ...
    right: 160px;                    /* Располагает контейнер на 60 пикселей от правого края */
